...
To alleviate various limitations of Graph Neural Networks (GNNs)  used in Graph Representation Learning (GRL), Topological Deep Learning (TDL) is emerging as a new frontier \cite{papamarkou_position:_2024}. 
TDL has shown promising results in tackling two common issues in GNNs: 
\begin{itemize}
    \item over-smoothing: where node features become too similar after multiple graph convolutions[CITATION NEEDED]

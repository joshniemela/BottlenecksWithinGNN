...
It has two parameters, one weight and one bias.

The problem we wanted the model to solve, is what the sum of the children should be.
For the unnormalised model, this is simply the sum of the children and 
we get a weight of $\approx 1$ and a bias of $\approx 0$.
SHOW RESULTS HERE

For the normalised model, we get a weight of $\approx 1.72$ and a bias of $\approx 0$.
This is due to the diagonal normalisation.
